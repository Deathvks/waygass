...
export default function VerifyEmail() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white dark:bg-[#0f172a] flex flex-col justify-center items-center px-4">
      <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl max-w-md w-full text-center shadow-xl">
        {status === 'loading' && (
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-sm font-bold text-orange-500 bg-orange-50 dark:bg-orange-500/10 p-4 rounded-xl">
        ...
        {status === 'error' && (
          <>
            ...
            <button
              ...
              className="w-full py-3 bg-slate-900 dark:bg-orange-500 text-white font-bold rounded-xl"
            >
              Volver al inicio
            </button>
          </>
