...
export default function NavigationDock({ activeTab, setActiveTab, isAdmin }) {
 ...
 return (
 <div className="flex justify-around items-center h-14 px-2 w-full max-w-md mx-auto rounded-2xl bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border border-slate-200/50 dark:border-white/10">
 {tabs.map(tab => (
 <button
 key={tab.id}
