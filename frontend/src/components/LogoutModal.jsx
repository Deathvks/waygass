...
export default function LogoutModal({ isOpen, onClose, onConfirm }) {
 ...
 {/* Contenido del modal */}
 <div className="relative w-full max-w-sm bg-white dark:bg-black rounded-[32px] border border-white/20 dark:border-white/10 p-6 overflow-hidden animate-in fade-in zoom-in-95 duration-200 shadow-none">
