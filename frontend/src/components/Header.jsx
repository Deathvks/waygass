...
export default function Header({ isPro, openSettings, openSub, user, openProfile, openSecurity }) {
 ...
 <span>PRO</span>
      ...
      {user?.role === 'admin' && (
        <button onClick={openSecurity} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition" title="Ciberseguridad">
