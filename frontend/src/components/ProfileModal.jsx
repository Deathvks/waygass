...
export default function ProfileModal({ isOpen, onClose, user, onLogout, openSub, openSettings }) {
 ...
 <button 
 onClick={onClose}
 className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-slate-100 dark:bg-[#0c0c0e] text-slate-500 dark:text-slate-400 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition"
 >
 ...
 <div className="bg-slate-50 dark:bg-[#0c0c0e]/50 rounded-2xl p-4 flex items-center justify-between border border-slate-100 dark:border-slate-700/50">
 <div>
 ...
 Mejorar a PRO
        ...
        <button
          ...
          className="w-full px-4 py-3.5 rounded-2xl font-bold text-sm text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-[#0c0c0e]/50 hover:bg-slate-100 dark:hover:bg-[#0c0c0e] transition-colors flex items-center justify-center gap-2 border border-slate-100 dark:border-white/5"
        >
