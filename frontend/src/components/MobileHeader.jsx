...
export default function MobileHeader({ user, openProfile, onSearch, loadingSearch, onGps, isUsingGps }) {
  ...
  return (
    <div className={`relative flex items-center glass-core rounded-full px-4 py-1.5 gap-2 pointer-events-auto w-full mx-auto shadow-sm transition-all duration-300 ${isFocused || query.length > 0 ? "max-w-[95%]" : "max-w-[340px]"}`}>
