...
function AddManualView({ onBack, onSave }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-black border border-slate-200/50 dark:border-white/5 p-5 rounded-2xl">
                  ...
                  {garage.map(car => (
                    <div 
                      ...
                      className={`p-5 rounded-2xl cursor-pointer transition-all border ${
                        ...
                        : 'bg-white dark:bg-black border-slate-200/50 dark:border-white/5 opacity-70 hover:opacity-100'
                      }`}
                    >
                ...
                <div className="grid grid-cols-3 gap-3">
                  {POPULAR_BRANDS.map(brand => (
                    <button
                      ...
                      className="bg-white dark:bg-black border border-slate-200/50 dark:border-white/5 p-4 rounded-2xl flex flex-col items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
                    >
              ...
              <div className="flex flex-col gap-2">
                {selectedBrand.models.map((model, i) => (
                  <button
                    ...
                    className="bg-white dark:bg-black border border-slate-200/50 dark:border-white/5 p-4 rounded-xl flex items-center justify-between hover:bg-slate-100 dark:hover:bg-white/10 transition-colors text-left"
                  >
