...
export default function GarageView({ settings, setSettings }) {
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-y-auto no-scrollbar pb-24">
      <div className="p-6 pb-2 border-b border-slate-200/50 dark:border-white/10 flex items-center justify-between sticky top-0 bg-white/80 dark:bg-[#000000]/80 backdrop-blur-xl z-10">
        <div>
